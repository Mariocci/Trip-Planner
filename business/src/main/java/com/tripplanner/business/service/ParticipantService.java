...
public interface ParticipantService {
    ...
    /**
     * Updates a participant's role. Only organizers can update roles.
     *
     * @param participantId the ID of the participant to update
     * @param organizerId the ID of the organizer updating the role
     * @param updateDTO the role update data
     * @return the updated participant
     * @throws RuntimeException if organizer access denied
     */
